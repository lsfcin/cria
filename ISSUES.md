...
> Generated by `core/hooks/entropy/dashboard/entropy-dashboard.py`, which scans `code/cria`. Never edit inside this block, and never copy a count out of it — a copied number is the drift these checks exist to catch.

2026-09-04 · 5 tracked files scanned · **6 findings here**
...
- ROADMAP.md: retired token '/loops' survives (line 13).
...
- code/cria — main is 19 ahead of origin/main
