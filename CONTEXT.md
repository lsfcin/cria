# cria
> Workflow executável de ideação híbrida (motores de criatividade + score de fronteira semântica + kill-tests). Twin de pesquisa: `academy/papers/2027-CHI-cria/`.
> goal: [cria](../../brain/goals/cria.md)
